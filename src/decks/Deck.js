    ...
    <div>
      ...
      <div className="Deck-select-deck-div">
        ...
        <div className="Deck-select-deck-btns-div">
          ...
          <button type="button" className="Deck-delete-deck-btn btn btn-danger" 
        ...
        <div className="Deck-card-div" key={ index } >
          ...
          <div className="Deck-card-div-back-div" >
            ...
            <div className="Deck-card-div-btns-div" >
              ...
              <button type="button" className="Deck-delete-card-btn btn btn-danger" 
              onClick={ () => handleDeleteCard( card.id ) } >
                <img width="18" height="18" src="https://img.icons8.com/material-rounded/24/000000/trash.png" 
                alt="trash" className="trashcan-img" />
              </button>
            </div>
          </div>
        </div>
