...
function CreateDeck() {
    ...
    'key' with the "description" 'variable' as its 'value'. The "createDeck" 
    'function' is then 'called' with the "newDeck" 'variable' and 
    "abortController.signal" as its 'arguments'. The "setName" and "setDescription"
     'functions' are 'called' with empty 'strings' ("") for their 'arguments'. */
